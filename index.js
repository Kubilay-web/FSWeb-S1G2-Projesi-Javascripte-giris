...
function oyun(oyuncu="Makas",bilgisayar="Kağıt")
{
...
console.log("bilgisayar test",bilgisayarınSecimi());
console.log("oyun test",oyun("Makas","Kağıt"));
...
console.log("mılDonustur",milDonusturucu(10));
...
console.log("feetDonustur",feetDonusturucu(20));
...
for(let i=0;i<maymun;i++){
  console.log("cocukSarkisi",cocukSarkisi(maymun-i));
}
...
console.log("Notunuz: "+notHesapla(80));
